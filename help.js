      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: '產生 AI 報告', desc: '送出分析請求，跳轉到 AI 報告頁，AI 約 5–10 分鐘完成深度報告。' },
          ]
        },
        {
          heading: '觀察清單管理',
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: '產生 AI 分析報告', desc: '送出請求，AI 同時分析多時框技術面、法人籌碼、近期財報、產業競爭地位，約 5–10 分鐘完成。' },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'SEMA（藍點）', desc: 'SEMA5 與 SEMA8 均線同時上彎，代表中短期均線結構轉為多頭，技術面有利。' },
          ]
        },
        {
          heading: '如何解讀 & 使用',
          items: [
            { term: 'X/6 命中數', desc: '命中訊號越多（如 5/6、6/6），代表基本面 + 技術面 + 籌碼面越齊全，潛力越強。灰點 = 未命中。' },
            { term: '點擊股票', desc: '點任一股票列，直接跳轉到個股儀表板，自動分析並展開該股票的完整水位計。' },
            { term: '美股 / 台股切換', desc: '頁面上方可切換美股與台股兩個市場的掃描結果，各自獨立篩選。' },
